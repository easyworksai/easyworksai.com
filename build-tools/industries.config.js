...
module.exports = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Treatment-plan follow-up', desc: 'A client who comes in for a facial often needs the next one in 4-6 weeks. The system queues the reminder, suggests rebooking, and offers a small loyalty incentive at the right moment. Built to lift rebooking without anyone at the front desk chasing it.' },
  ...
  // ---- US and Canada vertical pages for the ad test (2026-09-18). Source: 01_Strategy/Targeting_Research_2026-09-18.md ----
  {
    slug: 'med-spas',
    lander: 'med-spas', scanKey: 'medspa',
    industry: 'Med Spas',
    region: 'Canada and the US',
    areaServed: ['Canada','United States'],
    keywords: ['med spa lead follow up', 'med spa answering service', 'med spa marketing system'],
    title: 'Growth Systems for Med Spas and Aesthetics Clinics',
    tagline: 'You already pay for the enquiry. We make sure it becomes a booked consult, and that the client comes back.',
    intro: `A med spa enquiry is a decision made in the moment. Someone sees your ad at 9pm, fills in the form, and by morning they have booked with whoever replied first. Most clinics reply the next day, from a shared inbox, between treatments. The ad spend keeps going out and the consult calendar stays half full. The Blueprint maps how fast your enquiries get answered, how many become consults, and how many clients come back, then we build only what it finds.`,
    services: [
      { name: 'Enquiries answered in under a minute', desc: 'Every form, call, text and Instagram message gets a reply right away, day or night, in your brand voice. It answers the common questions and offers a consult time before the person moves on.' },
      { name: 'Consult booking and reminders', desc: 'Consults go straight into your calendar, confirmed and reminded, with a deposit step if you use one. Works with Boulevard, Zenoti, Vagaro and Mindbody.' },
      { name: 'Rebooking and treatment plans', desc: 'When a client is due for their next treatment, they hear from you before they start looking elsewhere. Lapsed clients get a warm invitation back.' },
      { name: 'Reviews and Google Business Profile', desc: 'A polite review request after every visit and a fully built Google Business Profile, so you show up when someone nearby searches for a treatment.' },
      { name: 'Ads you can trace', desc: 'Meta and Google campaigns tied to booked consults, with a plain report that shows which ad produced which client.' },
    ],
    why: [
      `Every engagement starts with a Blueprint of your enquiry speed, consult booking rate, rebooking and reviews. You see where clients are being lost before we build anything.`,
      `Regulated treatments stay with your clinical team. The system books consults and follow ups. It does not advise on or sell injectables, and we set it up to follow the advertising rules where you operate.`,
      `Founder led and done for you. The person you talk to on the first call is the person who builds it, and we run it every month.`,
    ],
    faq: [
      { q: 'Does it work with Boulevard, Zenoti, Vagaro or Mindbody?', a: 'Yes. Bookings and client records land in the system your team already uses.' },
      { q: 'How does it handle injectables and other regulated treatments?', a: 'It never gives clinical advice and never books a first time regulated treatment directly. Those go to a consult with your clinical team. Rules differ by state and province, so we set this up with you.' },
      { q: 'Will it sound like our brand?', a: 'Yes. We set the tone and vocabulary with you during the build, so replies sound like your front desk on a good day.' },
    ],
    ctaTitle: 'Ready to see how many enquiries never become consults?',
  },
  {
    slug: 'dental',
    lander: 'dental', scanKey: 'dentist',
    industry: 'Dental Practices',
    region: 'Canada and the US',
    areaServed: ['Canada','United States'],
    keywords: ['dental answering service', 'dental new patient calls', 'dental recall system'],
    title: 'Growth Systems for Dental Practices',
    tagline: 'Every new patient call answered. Every cleaning rebooked. Every happy patient asked for a review.',
    intro: `A new patient calls during the lunch rush, gets voicemail, and books with the next practice on the list. Hygiene recalls slip because the front desk is busy with the patients in front of them. Reviews trickle in when they should be steady. None of this is a people problem. It is a systems problem, and the Blueprint maps exactly where your practice is losing patients before we build anything.`,
    services: [
      { name: 'Every call answered', desc: 'New patient calls are answered during lunch, after hours and when every line is busy. Common questions about insurance, hours and services are handled, and the appointment is booked.' },
      { name: 'Hygiene recall and rebooking', desc: 'Patients due for a cleaning hear from you by text and email until they book. Unscheduled treatment gets a gentle follow up too.' },
      { name: 'Reminders that cut no-shows', desc: 'Confirmations and reminders go out on a schedule, and a cancelled slot gets offered to the waitlist.' },
      { name: 'Reviews and Google Business Profile', desc: 'A review request after every visit and a fully built Google Business Profile, so you show up in the map results for your area.' },
      { name: 'One record for every patient conversation', desc: 'Calls, texts, forms and web chat in one place, connected to the practice software you already use.' },
    ],
    why: [
      `Every engagement starts with a Blueprint of your call handling, recall, no-shows and reviews. You see where patients are being lost before we build anything.`,
      `It runs beside your practice software. We do not ask you to replace what your team already knows.`,
      `Founder led and done for you. The person you talk to on the first call is the person who builds it, and we run it every month.`,
    ],
    faq: [
      { q: 'Do we have to change our practice software?', a: 'No. The system runs beside what you already use, and we connect to it where the software allows.' },
      { q: 'Can it answer insurance questions?', a: 'It answers the common ones you give it, such as which plans you accept. Anything specific to a patient goes to your team.' },
      { q: 'What about patient privacy?', a: 'We set the system up to keep clinical details out of it. It handles booking, reminders and general questions. We walk through the privacy rules that apply to your practice during the Blueprint.' },
    ],
    ctaTitle: 'Ready to see how many new patients never get through?',
  },
];
